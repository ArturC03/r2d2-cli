const std = (function () {function print(s) { console.log(s); }function println(s) { console.log(s + "\n"); }function printf(formatStr, a, b, c, d, e) {
    ...
    }function exit(code) { process.exit(code); }function getEnv(name) { return process.env[name] || ""; }function setEnv(name, value) { process.env[name] = value; }return {setEnv, randomInt, indexOf, print, lengthStr, trim, toLower, minVal, readFile, println, substring, appendFile, fileExists, getEnv, printf, floor, ceil, contains, exec, abs, round, random, reverse, exit, input, pow, now, replaceStr, join, maxVal, sort, sleep, formatDate, writeFile, split, toUpper, sqrt}; })();const jj = (function () {var x = 0;function main() {var x = 0;x += 2;while (x<10) {x = x+1;std.print(x);break;}switch (x) {case 10:std.print("x is 10");break;case 20:std.print("x is 20");break;default:std.print("x is not 10 or 20");}if (x==10) {std.print("x is 10");} else {std.print("x is 20");}for (x = 0; x<10; x = x+1) {std.print(x);} 
